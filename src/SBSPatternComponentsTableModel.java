...
public class SBSPatternComponentsTableModel extends AbstractTableModel
{
   ...
   public void query() throws Exception
   {
      ...
      while (rset.next())
      {
         pattern_component_id = new Integer(rset.getInt(1));
         position             = new Integer(rset.getInt(2));
         component_id         = new Integer(rset.getInt(3));
      ...
      if (conn.getMetaData().getDatabaseProductName().equals("MySQL"))
      {
		...
		while (rset.next())
		{
			component_id_cache.add(new Integer(rset.getInt(1)));
