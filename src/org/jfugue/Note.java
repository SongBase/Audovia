...
public final class Note implements JFugueElement
{
    ...
    public String getMusicString()
    {
        ...
        //buddy.append(Note.getStringForNote(this.value, this.decimalDuration)); // commented out D G Gray 4th Feb 2017

        buddy.append(getStringForNote(this.value)); // added D G Gray 4th Feb 2017
        if (isEndOfTie) buddy.append("-"); // added D G Gray 4th Feb 2017
        buddy.append(getStringForDuration(this.decimalDuration)); // added D G Gray 4th Feb 2017
        if (isStartOfTie) buddy.append("-"); // added D G Gray 4th Feb 2017
