/*
 * Messages.java
 * Copyright (C) 2009, 2011, 2019  Donald G Gray
 *
 * http://gray10.com/
 *
...
//      else
   ...
   public static int plainQuestion(JDialog frame, String title, String question)
   {
      int selection =
      JOptionPane.showConfirmDialog
         (frame,
   ...
   public static int warningQuestion(JDialog frame, String title, String question)
   {
      int selection =
      JOptionPane.showConfirmDialog
         (frame,
