...
public class SBSPatternsTableModel extends AbstractTableModel
{
	/*
	 * version 3.0.0
	 *
   ...
   public SBSPatternsTableModel(Connection aConnection, Integer aSongId)
   {
      conn = aConnection;
      song_id = aSongId;
   }
   ...
   public void query() throws Exception
   {
      ...
      {
			cStmt = conn.prepareCall("{call get_patterns(?)}");
      ...
      while (rset.next())
      {
         pattern_id    = Integer.valueOf(rset.getInt(1));
