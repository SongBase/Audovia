 ...
 * Copyright (C) 2010 - 2019  Donald G Gray
 *
 * http://gray10.com/
 *
...
public class SBSSongs extends JFrame
{
   ...
   private Class<?> c = Class.forName("com.gray10.audovia.SBSSongs");  // try this
   ...
   private void save() throws Exception
   {
      ...
      if (status.equals("inserted"))
      {
            ...
            if (session_user == null)
            {
               ...
               while (rset.next()) song_id = Integer.valueOf(rset.getInt(1));
               rset.close();
                  ...
                  try
                  {
                     ...
                     if (result == JFileChooser.APPROVE_OPTION)
                     {
                        ...
                        while (rset.next())
                        {
                           ...
                           component_position = Integer.valueOf(rset.getInt(2));
...
//         }
			...
			try
			{
			   if (System.getProperty("os.name").startsWith("Windows"))
			   {
                  ...
                  myDesktop.browse(new URI("https://songbase.github.io/doc/AudoviaDocumentation-4-0.pdf"));
		       }
		       else
		       {
