/*
 * FormStyleRomanInset.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleRomanInset extends JDialog
{
	/*
	 * version 1.0.23
	 *
   ...
   private JDialog frame = FormStyleRomanInset.this;

   private static String title = "Roman (inset) (inside view)";

   public FormStyleRomanInset()
   {
