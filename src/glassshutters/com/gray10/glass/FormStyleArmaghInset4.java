/*
 * FormStyleArmaghInset4.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleArmaghInset4 extends JDialog
{
	/*
	 * version 1.0.26
	 *
   ...
   private JTextField revealField = new JTextField();

   private JDialog frame = FormStyleArmaghInset4.this;

   private static String title = "Armagh (inset) (4 hinges) (inside view)";

   public FormStyleArmaghInset4()
   {
      ...
      JLabel lhLabel = new JLabel("LH1 - LH2 (left hinges)");
      ...
      JLabel rhLabel = new JLabel("RH1 - RH2 (right hinges)");
      ...
      JLabel revealLabel = new JLabel("Reveal (depth to hinge)");
      revealLabel.setBounds(25,440,175,30);
      contentPane.add(revealLabel);
      revealField.setBounds(200,440,65,30);
      contentPane.add(revealField);
   ...
   {
      return Double.parseDouble(revealField.getText());
   }
