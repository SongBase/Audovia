/*
 * NewMajesticShortRight.java - Script Generator for Glass Shutters program
...
public class NewMajesticShortRight
{
   ...
   public static void run(String window, String style) throws Exception
   {
      ...
      FormStyleTshort template = new FormStyleTshort();
      ...
      if (result == JFileChooser.APPROVE_OPTION)
      {
         ...
         bufferedWriter.write("c " + Constants.point(j - intGap/2.0 - intCentre + xoff, k + yoff) + intDia);
         bufferedWriter.newLine();

         bufferedWriter.write("c " + Constants.point(j - intGap/2.0 - intCentre - intSpace + xoff, k + yoff) + intDia);
         bufferedWriter.newLine();
   ...
   public static void writeAudit(File auditFile, BufferedWriter auditBufferedWriter) throws Exception
   {
	  ...
	  auditBufferedWriter.write("K (top bar)     " + Double.toString(k));
	  auditBufferedWriter.newLine();
	  auditBufferedWriter.newLine();
