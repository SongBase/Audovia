/*
 * NewMajesticShortLeft.java - Script Generator for Glass Shutters program
...
public class NewMajesticShortLeft
{
   ...
   public static void run(String window, String style) throws Exception
   {
      ...
      if (result == JFileChooser.APPROVE_OPTION)
      {
         ...
         bufferedWriter.write("c " + Constants.point(-i - intGap/2.0 - intCentre + xoff, k + yoff) + intDia);
         bufferedWriter.newLine();

         bufferedWriter.write("c " + Constants.point(-i - intGap/2.0 - intCentre - intSpace + xoff, k + yoff) + intDia);
         bufferedWriter.newLine();
