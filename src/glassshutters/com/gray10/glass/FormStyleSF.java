/*
 * FormStyleSF.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleSF extends JDialog
{
	/*
	 * version 1.0.22
	 *
   ...
   private JDialog frame = FormStyleSF.this;

   private static String title = "Sterling hinged left (inside view)";
