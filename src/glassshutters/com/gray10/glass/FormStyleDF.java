/*
 * FormStyleDF.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleDF extends JDialog
{
	/*
	 * version 1.0.22
	 *
   ...
   private JDialog frame = FormStyleDF.this;

   private static String title = "Regal (inside view)";
