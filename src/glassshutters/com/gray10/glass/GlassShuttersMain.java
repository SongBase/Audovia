/*
 * GlassShuttersMain.java - Script Generator for Glass Shutters.
...
public class GlassShuttersMain extends JDialog
{
	/*
	 * version 3.3.7
	 *
   ...
   private static GlassShuttersMain maintemplate;

   private JTextField wField = new JTextField();

   private JComboBox<String> styleComboBox = new JComboBox<String>();

   private JDialog frame = GlassShuttersMain.this;

   private static String title = "Glass Shutters 3.3.7";

   public GlassShuttersMain()
   {
      ...
      ConfigureAction configAction = new ConfigureAction();
      configItem.addActionListener(configAction);
      ...
      contentPane.add(sLabel);
		...
		styleComboBox.addItem("New Majestic Short Left");
		styleComboBox.addItem("New Majestic Short Right");
		styleComboBox.addItem("New Majestic Strong Left");
		styleComboBox.addItem("New Majestic Strong Right");
      ...
      public void actionPerformed(ActionEvent a)
      {
		  ///////////////////////////////////////////////////////////////////////////////////////////
		         ...
		         if (s == null)
		         {
					...
					else if (s.equals("New Majestic Short Left")) NewMajesticShortLeft.run(w,s);
					else if (s.equals("New Majestic Short Right")) NewMajesticShortRight.run(w,s);
					else if (s.equals("New Majestic Strong Left")) NewMajesticStrongLeft.run(w,s);
					else if (s.equals("New Majestic Strong Right")) NewMajesticStrongRight.run(w,s);
		   ...
		   private  void styleS() throws Exception
		   {
		   ...
		   private  void styleSR() throws Exception
		   {
			...
			private  void styleSF() throws Exception
			{
		   ...
		   private  void styleSRF() throws Exception
		   {
			...
			private  void styleD() throws Exception
			{
			...
			private  void styleDF() throws Exception
			{
			...
			private  void styleT() throws Exception
			{
			...
			private  void styleNewT() throws Exception
			{
			...
			private  void styleNewTS() throws Exception
			{
			...
			private  void styleTR() throws Exception
			{
			...
			private  void styleTF() throws Exception
			{
			...
			private  void styleTRF() throws Exception
			{
			...
			private  void styleQ() throws Exception
			{
			...
			private  void styleQ4() throws Exception
			{
			...
			private  void styleQF() throws Exception
			{
			...
			private  void styleRoman() throws Exception
			{
			...
			private  void styleRoman5() throws Exception
			{
			...
			private  void styleRoman4() throws Exception
			{
			...
			private  void styleRomanInset() throws Exception
			{
			...
			private  void styleRomanInset5() throws Exception
			{
			...
			private  void styleRomanInset4() throws Exception
			{
			...
			private  void styleArmaghInset4() throws Exception
			{
      ...
      public void actionPerformed(ActionEvent a)
      {
         try
         {
            ...
            output.append("Glass Shutters - Application for creating CAD scripts for drawing \n" +
                          "Glass Shutters version 3.3.7  Copyright (C) 2012 - 2018  Donald G Gray \n" +
                          "\n" +
                          "http://glass.gray10.com/ \n" +
                          "\n" +
                          "This program is free software: you can redistribute it and/or modify \n" +
   ...
   private class ConfigureAction implements ActionListener
   {
      public void actionPerformed(ActionEvent a)
      {
         try
         {
			 FormStyleConstants template = new FormStyleConstants();
			 template.setVisible(true);

			 Constants.endGap = template.getendGap();
			 Constants.sideGap = template.getsideGap();
			 Constants.intGap = template.getintGap();
			 Constants.endCentre = template.getendCentre();
			 Constants.intCentre = template.getintCentre();
			 Constants.sideCentre = template.getsideCentre();
			 Constants.sideSpace = template.getsideSpace();
			 Constants.intSpace = template.getintSpace();
			 Constants.endCatch = template.getendCatch();
			 Constants.sideCatch = template.getsideCatch();
			 Constants.extDia = template.getextDia();
			 Constants.intDia = template.getintDia();
			 Constants.catchDia = template.getcatchDia();

            template.dispose();

            // update file
            File config_file = new File(new File(new File(new File(System.getProperty("user.home"),"Documents"),"Glass Shutters"),"config"),"config.xml");
             ...
             bufferedWriter.write("    <endGap>" + Double.toString(Constants.endGap) + "</endGap>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideGap>" + Double.toString(Constants.sideGap) + "</sideGap>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intGap>" + Double.toString(Constants.intGap) + "</intGap>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <endCentre>" + Double.toString(Constants.endCentre) + "</endCentre>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideCentre>" + Double.toString(Constants.sideCentre) + "</sideCentre>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intCentre>" + Double.toString(Constants.intCentre) + "</intCentre>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideSpace>" + Double.toString(Constants.sideSpace) + "</sideSpace>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intSpace>" + Double.toString(Constants.intSpace) + "</intSpace>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <endCatch>" + Double.toString(Constants.endCatch) + "</endCatch>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideCatch>" + Double.toString(Constants.sideCatch) + "</sideCatch>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <extDia>" + Constants.extDia + "</extDia>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intDia>" + Constants.intDia + "</intDia>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <catchDia>" + Constants.catchDia + "</catchDia>");
             bufferedWriter.newLine();
   ...
   public static void main(String[] args)
   {
      try
      {
         ...
         System.out.println("Glass Shutters version 3.3.7");
         ...
         file = new File(new File(new File(System.getProperty("user.home"),"Documents"),"Glass Shutters"),"config");
         if (! file.exists())
         {
			 file.mkdir();

             FileWriter fileWriter = new FileWriter(new File(file, "config.xml"));
             BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
             ...
             bufferedWriter.write("    <endGap>3.0</endGap>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideGap>4.0</sideGap>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intGap>3.0</intGap>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <endCentre>17.0</endCentre>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideCentre>17.0</sideCentre>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intCentre>17.0</intCentre>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideSpace>32.0</sideSpace>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intSpace>21.0</intSpace>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <endCatch>18.0</endCatch>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <sideCatch>20.0</sideCatch>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <extDia> d 8</extDia>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <intDia> d 8</intDia>");
             bufferedWriter.newLine();

             bufferedWriter.write("    <catchDia> d 12</catchDia>");
             bufferedWriter.newLine();
         ...
         // get constants from file
            ...
            Constants.endGap = handler.getendGap();
            Constants.sideGap = handler.getsideGap();
            Constants.intGap = handler.getintGap();
            Constants.endCentre = handler.getendCentre();
            Constants.sideCentre = handler.getsideCentre();
            Constants.intCentre = handler.getintCentre();
            Constants.sideSpace = handler.getsideSpace();
            Constants.intSpace = handler.getintSpace();
            Constants.endCatch = handler.getendCatch();
            Constants.sideCatch = handler.getsideCatch();
            Constants.extDia = handler.getextDia();
            Constants.intDia = handler.getintDia();
            Constants.catchDia = handler.getcatchDia();

         // end get constants from file

         maintemplate = new GlassShuttersMain();
         maintemplate.setVisible(true);

         }
         catch (Exception e)
		 {
		    Messages.exceptionHandler(title, e);
         }
	}
}
