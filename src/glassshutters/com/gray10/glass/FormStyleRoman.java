/*
 * FormStyleRoman.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleRoman extends JDialog
{
	/*
	 * version 1.0.20
	 *
   ...
   private JDialog frame = FormStyleRoman.this;

   private static String title = "Roman (inside view)";

   public FormStyleRoman()
   {
