/*
 * FormStyleTstrong.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
 * Copyright (C) 2012, 2013, 2014, 2015, 2018  Donald G Gray
 *
...
public class FormStyleTstrong extends JDialog
{
	/*
	 * version 3.3.6
	 *
   ...
   private JTextField ehField = new JTextField();

   private JDialog frame = FormStyleTstrong.this;

   private static String title = "Majestic Strong (inside view)";

   public FormStyleTstrong()
   {
      ...
      JLabel ehLabel = new JLabel("EH (extra hinge)");
      ehLabel.setBounds(25,410,175,30);
      contentPane.add(ehLabel);
      ehField.setBounds(200,410,65,30);
      contentPane.add(ehField);
   ...
   public double getEH()
   {
      return Double.parseDouble(ehField.getText());
   }
