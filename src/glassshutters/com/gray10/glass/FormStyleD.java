/*
 * FormStyleD.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleD extends JDialog
{
	/*
	 * version 2.2.0
	 *
   ...
   private JDialog frame = FormStyleD.this;

   private static String title = "Monarch (inside view)";
