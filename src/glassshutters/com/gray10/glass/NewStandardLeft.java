/*
 * NewStandardLeft.java - Script Generator for Glass Shutters program
...
public class NewStandardLeft
{
   ...
   public static void run(String window, String style) throws Exception
   {
      ...
      chooser.setSelectedFile(new File("NewStandardLeft-" + Constants.today + "-" + w + ".scr"));
      ...
      if (result == JFileChooser.APPROVE_OPTION)
      {
         ...
         bufferedWriter.newLine();
         bufferedWriter.write(Constants.userHome + "\\Documents\\Glass Shutters\\dwg\\NewStandardLeft-" + Constants.today + "-" + w);
         bufferedWriter.newLine();
         ...
         File auditFile = new File(Constants.userHome + "\\Documents\\Glass Shutters\\audit\\NewStandardLeft-" + Constants.today + "-" + w + ".txt");
