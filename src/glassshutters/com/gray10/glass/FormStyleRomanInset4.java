/*
 * FormStyleRomanInset4.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleRomanInset4 extends JDialog
{
	/*
	 * version 1.0.23
	 *
   ...
   private JDialog frame = FormStyleRomanInset4.this;

   private static String title = "Roman (inset) (4 hinges) (inside view)";

   public FormStyleRomanInset4()
   {
