/*
 * FormStyleRomanInset5.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleRomanInset5 extends JDialog
{
	/*
	 * version 1.0.23
	 *
   ...
   private JDialog frame = FormStyleRomanInset5.this;

   private static String title = "Roman (inset) (5 hinges) (inside view)";

   public FormStyleRomanInset5()
   {
