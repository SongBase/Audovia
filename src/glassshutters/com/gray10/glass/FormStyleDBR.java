/*
 * FormStyleDBR.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleDBR extends JDialog
{
	/*
	 * version 3.2.4
	 *
   ...
   private JDialog frame = FormStyleDBR.this;

   private static String title = "Monarch bi-folding hinged on right (inside view)";
   ...
   public FormStyleDBR()
   {
      ...
      JLabel lhLabel = new JLabel("LMR (left meeting rail)");
