/*
 * FormStyleQ5.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleQ5 extends JDialog
{
	/*
	 * version 3.2.5
	 *
   ...
   private JDialog frame = FormStyleQ5.this;

   private static String title = "Regent (5 hinges) (inside view)";
