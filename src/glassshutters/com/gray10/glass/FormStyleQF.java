/*
 * FormStyleQF.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleQF extends JDialog
{
	/*
	 * version 1.0.20
	 *
   ...
   private JDialog frame = FormStyleQF.this;

   private static String title = "Viceroy (inside view)";
