/*
 * FormStyleRoman4.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleRoman4 extends JDialog
{
	/*
	 * version 1.0.21
	 *
   ...
   private JDialog frame = FormStyleRoman4.this;

   private static String title = "Roman (4 hinges) (inside view)";

   public FormStyleRoman4()
   {
