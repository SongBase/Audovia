/*
 * NewStandardRight.java - Script Generator for Glass Shutters program
...
public class NewStandardRight
{
   ...
   public static void run(String window, String style) throws Exception
   {
      ...
      chooser.setSelectedFile(new File("NewStandardRight-" + Constants.today + "-" + w + ".scr"));
      ...
      if (result == JFileChooser.APPROVE_OPTION)
      {
         ...
         bufferedWriter.newLine();
         bufferedWriter.write(Constants.userHome + "\\Documents\\Glass Shutters\\dwg\\NewStandardRight-" + Constants.today + "-" + w);
         bufferedWriter.newLine();
         ...
         File auditFile = new File(Constants.userHome + "\\Documents\\Glass Shutters\\audit\\NewStandardRight-" + Constants.today + "-" + w + ".txt");
