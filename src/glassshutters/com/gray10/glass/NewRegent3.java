/*
 * NewRegent3.java - Script Generator for Glass Shutters program
...
public class NewRegent3
{
   ...
   public static void run(String window, String style) throws Exception
   {
      ...
      chooser.setSelectedFile(new File("NewRegent3-" + Constants.today + "-" + w + ".scr"));
      ...
      if (result == JFileChooser.APPROVE_OPTION)
      {
         ...
         bufferedWriter.newLine();
         bufferedWriter.write(Constants.userHome + "\\Documents\\Glass Shutters\\dwg\\NewRegent3-" + Constants.today + "-" + w);
         bufferedWriter.newLine();
         ...
         File auditFile = new File(Constants.userHome + "\\Documents\\Glass Shutters\\audit\\NewRegent3-" + Constants.today + "-" + w + ".txt");
