/*
 * FormStyleTF.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleTF extends JDialog
{
	/*
	 * version 1.0.20
	 *
   ...
   private JDialog frame = FormStyleTF.this;

   private static String title = "Imperial (inside view)";
