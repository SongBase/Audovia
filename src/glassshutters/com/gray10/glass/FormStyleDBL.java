/*
 * FormStyleDBL.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleDBL extends JDialog
{
	/*
	 * version 3.2.4
	 *
   ...
   private JDialog frame = FormStyleDBL.this;

   private static String title = "Monarch bi-folding hinged on left (inside view)";
   ...
   public FormStyleDBL()
   {
      ...
      JLabel rhLabel = new JLabel("RMR (right meeting rail)");
