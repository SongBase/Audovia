/*
 * NewMonarchBiLeft.java - Script Generator for Glass Shutters program
...
public class NewMonarchBiLeft
{
   ...
   public static void run(String window, String style) throws Exception
   {
      ...
      FormStyleDBL template = new FormStyleDBL();
      ...
      chooser.setSelectedFile(new File("NewMonarchBiLeft-" + Constants.today + "-" + w + ".scr"));
      ...
      if (result == JFileChooser.APPROVE_OPTION)
      {
         ...
         //bufferedWriter.write("c " + Constants.point(m2 - sideGap - sideCentre + xoff, rh + sideSpace/2.0 + yoff) + extDia);
         //bufferedWriter.newLine();
         ...
         bufferedWriter.write("c " + Constants.point(h - sideGap - sideCatch + xoff, -f + endGap + endCatch + yoff) + catchDia);
         bufferedWriter.newLine();
         ...
         bufferedWriter.newLine();
         bufferedWriter.write(Constants.userHome + "\\Documents\\Glass Shutters\\dwg\\NewMonarchBiLeft-" + Constants.today + "-" + w);
         bufferedWriter.newLine();
         ...
         File auditFile = new File(Constants.userHome + "\\Documents\\Glass Shutters\\audit\\NewMonarchBiLeft-" + Constants.today + "-" + w + ".txt");
   ...
   public static void writeAudit(File auditFile, BufferedWriter auditBufferedWriter) throws Exception
   {
	  ...
	  auditBufferedWriter.write("RMR (right meeting rail)  " + Double.toString(rh));
	  auditBufferedWriter.newLine();
	  auditBufferedWriter.newLine();
