/*
 * FormStyleTshort.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleTshort extends JDialog
{
	/*
	 * version 3.3.4
	 *
   ...
   private JDialog frame = FormStyleTshort.this;

   private static String title = "Majestic Short (inside view)";

   public FormStyleTshort()
   {
      ...
      JLabel kLabel = new JLabel("K (top glazing bar)");
