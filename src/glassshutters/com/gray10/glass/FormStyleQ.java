/*
 * FormStyleQ.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleQ extends JDialog
{
	/*
	 * version 2.2.0
	 *
   ...
   private JDialog frame = FormStyleQ.this;

   private static String title = "Regent (inside view)";
