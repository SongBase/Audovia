/*
 * FormStyleSRF.java - Script Generator for Glass Shutters to NT specifications, all corners rounded.
...
public class FormStyleSRF extends JDialog
{
	/*
	 * version 1.0.22
	 *
   ...
   private JDialog frame = FormStyleSRF.this;

   private static String title = "Sterling hinged right (inside view)";
