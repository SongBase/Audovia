...
public class SBSPatterns extends JFrame
{
   ...
   private Class c = Class.forName("SBSPatterns");
                  ...
                  try
                  {
                     ...
                     //  end of save all other unsaved edits
                        ...
                        if (session_user == null)
                        {
                           ...
                           rset = insertStmt.getGeneratedKeys();
                           while (rset.next()) clone_pattern_id = new Integer(rset.getInt(1));
                           rset.close();
								}
								else
								{
                     ...
                     insertStmt.execute();
		               ...
		               while (rset2.next())
		               {
			            	component_position   = new Integer(rset2.getInt(1));
				            if (rset2.wasNull()) component_position = null;
			            	component_id         = new Integer(rset2.getInt(2));
				            if (rset2.wasNull()) component_id = null;
